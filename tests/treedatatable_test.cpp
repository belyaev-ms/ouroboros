...
typedef control_block<skey_type, test_interface> controlblock_type;
...
typedef tree_data_table<interface_table, indexed_record_type, controlblock_type> datatable_type;
